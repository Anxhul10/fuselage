...
// ../../node_modules/@tamagui/config/node_modules/@tamagui/themes/dist/esm/utils.mjs
function sizeToSpace(v) {
  return v === 0 ? 0 : v === 2 ? 0.5 : v === 4 ? 1 : v === 8 ? 1.5 : v <= 16 ? Math.round(v * 0.333) : Math.floor(v * 0.7 - 12);
}
__name(sizeToSpace, "sizeToSpace");

// ../../node_modules/@tamagui/config/node_modules/@tamagui/themes/dist/esm/v4-tokens.mjs
var size = {
  $0: 0,
  "$0.25": 2,
  "$0.5": 4,
...
// ../../node_modules/@tamagui/config/node_modules/@tamagui/themes/dist/esm/generated-v4.mjs
function t(a) {
  let res = {};
